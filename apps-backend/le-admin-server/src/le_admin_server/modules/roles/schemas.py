...
ROLE_CODE_PATTERN = r"^[A-Za-z0-9_.-]+$"


class RoleCreateIn(BaseSchema):
    tenant_id: int = Field(..., ge=1)
    code: str = Field(..., min_length=1, max_length=64, pattern=ROLE_CODE_PATTERN)
...
class RoleStatusUpdateIn(BaseSchema):
    status: int = Field(..., ge=0, le=1)


class RoleQueryIn(ListQuerySchema):
