...
- `@`: 指向 `./src`（在子项目中会被覆盖）
- `utils`: 指向 `packages-web/utils/index.ts`
- `base`: 指向 `packages-web/base/index.ts`
...
### 8. `apps-web/vite-vue/vite.config.ts`
...
### 10. `apps-web/vite-vue/tsconfig.json`
...
### 11. `apps-web/vite-vue/tsconfig.app.json`
...
- `paths`: 路径映射
  - `@/*`: 指向 `./src/*`
  - `utils`: 指向 `../../packages-web/utils/src`
  - `base`: 指向 `../../packages-web/base/src`

**包含文件**:

- `src/**/*.ts`, `src/**/*.tsx`, `src/**/*.vue`

### 12. `apps-web/vite-vue/tsconfig.node.json`
...
### 17. `packages-web/utils/package.json`
...
### 18. `packages-web/base/package.json`
...
### 19. `apps-web/vite-vue/package.json`
