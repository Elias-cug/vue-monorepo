...
Vue Monorepo 的主题系统是一个功能强大、灵活且易于使用的主题管理解决方案，为整个应用提供统一的视觉风格和主题切换能力。

## 🎯 核心特性

- 🎨 **12 种预设主题** - 精心设计的配色方案，满足不同场景需求
- 🌓 **明暗模式** - 支持浅色/深色模式，自动适配系统偏好
- 🔄 **实时切换** - 无需刷新页面，主题切换立即生效
- 💾 **持久化存储** - 自动保存用户选择，下次访问时恢复
- 🎯 **CSS 变量系统** - 完整的设计令牌，易于定制和扩展
- 🔧 **动态主题生成** - 支持自定义颜色实时生成主题
- 📦 **组件自适应** - 所有 UI 组件自动响应主题变化
- 🎛️ **Naive UI 集成** - 深度集成 Naive UI 组件库
...
- [示例项目](https://github.com/Elias-cug/vue-monorepo)
